...
for TTT=1:length(file_list)
    ...
    B_Stack_1=permute(Image_Stack_Blur_AHist_Corr,[3 1 2]);
    ...
    for p=1:Total_Number_of_Frame
        ...
        Image_1st_Backup2=medfilt2(Image_1st_Backup,[Median_1 Median_1]);
        Image_1st=Image_1st_Backup2.^Exp_1;
        Image_1st=Image_1st./max(Image_1st(:)).*max(Image_1st_Backup2(:));
    ...
    Histogram_Corr_Image_Stack=permute(Histogram_Corr_Image_Stack,[2 3 1]);
